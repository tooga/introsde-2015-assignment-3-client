 ...
 * 
 */
@WebServiceClient(name = "PeopleService", targetNamespace = "http://soap.assignment.introsde/", wsdlLocation = "http://introsde-assignment3.herokuapp.com/ws/people?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PEOPLESERVICE_QNAME = new QName("http://soap.assignment.introsde/", "PeopleService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://introsde-assignment3.herokuapp.com/ws/people?wsdl");
    ...
    public People getPeopleImplPort() {
        return super.getPort(new QName("http://soap.assignment.introsde/", "PeopleImplPort"), People.class);
    }
    ...
    public People getPeopleImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.assignment.introsde/", "PeopleImplPort"), People.class, features);
    }
